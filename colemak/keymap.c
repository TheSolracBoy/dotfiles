...
//,-----------------------------------------------------.                    ,-----------------------------------------------------.
   OS_ALT,          KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                                                 KC_J,    KC_L,    KC_U,    KC_Y,   KC_QUOT,   OS_ALT,
//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
bool shift_pressed_once = false; // Variable para rastrear si Shift se presionó dos veces
bool caps_lock_active = false; // Variable para rastrear si Caps Lock está activo
