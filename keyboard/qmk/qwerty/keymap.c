...
//,-----------------------------------------------------.                    ,-----------------------------------------------------.
   OS_ALT,          KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                    KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,   OS_ALT,
//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  LCTL_T(KC_ESC),    (KC_A),    (KC_S),    (KC_D),    LT(NAV,KC_F),    KC_G,          KC_H,    (KC_J),    (KC_K),    (KC_L), (KC_SCLN),          LCTL_T(KC_QUOT),
//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  OS_SHFT,           KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                   KC_N,    KC_M, KC_COMM,  KC_DOT,  KC_SLSH,       OS_SHFT,
//|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                              OS_CMD,    LA_NAV,  LA_NUM,    KC_BSPC,  MO(SYM) , OS_CMD
                              //`--------------------------'  `--------------------------'
),
